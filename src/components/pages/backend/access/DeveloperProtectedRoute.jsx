...
const DeveloperProtectedRoute = () => {
  ...
  const jollibeetoken = JSON.parse(localStorage.getItem("jolibeetoken"));
  ...
  React.useEffect(() => {
    const fetchLogin = async () => {
      ...
      if (typeof login === "undefined" || !login.success) {
        ...
        delete login.data.user_data_developer_password;
        delete login.data.user_data_developer_key;
